...
INSERT INTO tb_employee (id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission, dt_resignation) VALUES (1,'Sandra de Fatima','sollicitudin@icloud.org','M',2,2,'248.686-73','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1988-10-25','2014-08-01','2018-04-20');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission, dt_resignation) VALUES (2,'Astra Brandao','massa.vestibulum@hotmail.net','M',2,2,'286.566-61','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1999-01-27','2018-04-20','2020-11-08');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission, dt_resignation) VALUES (3,'Anthony Chaves','dis.parturient@grupotsm.com','M',3,3,'266.349-16','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1975-10-14','2016-02-06','2018-12-01');

INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (4, 'Slade Santana','hendrerit@google.edu','M',1,1,'591.252-64','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1975-04-16','2019-01-30');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (5,'Randall Candido','feugiat.sed@icloud.edu','M',3,3,'718.348-26','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1976-03-26','2014-12-23');

INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (6,'Cheyenne Carneiro','nunc@outlook.org','M',5,5,'732.962-74','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1979-06-15','2020-11-08');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (7,'Alfreda Guimaraes','sapien@grupotsm.net','F',4,4,'176.388-75','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1975-12-09','2017-12-02');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (8,'Shea Paiva','cum.sociis.natoque@yahoo.couk','F',2,2,'792.864-48','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1993-05-21','2017-10-11');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (9,'Clark Messias','gravida.molestie@aol.net','M',3,3,'695.247-67','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1977-05-05','2015-11-28');
INSERT INTO tb_employee(id, name,email,gender,store_beloging_id, store_current_id,cpf,password,birth_date,dt_admission) VALUES (10,'Jeanette Sántos','luctus@grupotsm.org','M',2,2,'254.575-37','$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG','1993-06-14','2016-08-08');
